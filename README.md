...
_Spellscript_ is a procedural, library-dependent, interpreted programming language created by [JTnadrooi](). It’s extremely lightweight and tailored for straightforward, linear tasks.
...
Tests are available in the _[tests](docs/tests)_ folder. However, they are not yet executable. At present, this folder is primarily used for experimenting with potential syntax for **_Spellscript v02_**.
